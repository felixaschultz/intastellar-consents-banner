(function () {
    ...
    window.__intaCmpLocalePayload = {
        ...
        bannerMessage: "Bằng cách chấp nhận tất cả cookie, bạn hỗ trợ " + document.domain + " phát triển một giải pháp tốt hơn cho bạn.</p><p>Hãy chọn xem bạn muốn chỉ cho phép các cookie cần thiết hay cho phép tất cả cookie.",
        settingsMessage: "<h3 style=\"    font-size: 25px;\">Bạn có toàn quyền kiểm soát</h3>"
            + "<p>Chúng tôi và các đối tác đáng tin cậy sử dụng các công nghệ, chẳng hạn như cookie, để thu thập thông tin cho nhiều mục đích khác nhau, bao gồm:</p>"
            + "<ol>"
            + "<li>Chức năng</li>"
            + "<li>Phân tích</li>"
            + "<li>Tiếp thị</li>"
            + "</ol>"
            + "<p>Bằng cách nhấp vào 'Chấp nhận', bạn đồng ý với tất cả các mục đích này. Ngoài ra, bạn có thể chọn các mục đích cụ thể mà bạn đồng ý bằng cách đánh dấu vào các hộp kiểm và nhấp vào 'Lưu cài đặt'.</p>"
            + "<p>Bạn có thể rút lại sự đồng ý của mình bất cứ lúc nào bằng cách nhấp vào biểu tượng nhỏ ở góc dưới bên " + arrangeWord + " của trang web.</p>",
        settingsMessageSuffix: '<button onClick="showPrivacy()" class="intastellarCookie-settings__privacyLink">Chính sách quyền riêng tư của Intastellar Solutions, International</button>',
