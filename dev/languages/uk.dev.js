(function () {
    ...
    var arrangeWord = (window.INTA && window.INTA.settings && window.INTA.settings.arrange == "ltr") ? "лівому" : "правому";
    window.__intaCmpLocalePayload = {
        ...
        bannerMessage: "Приймаючи всі файли cookie, ви підтримуєте " + document.domain + " у розробці кращого рішення для вас.</p><p>Оберіть, чи хочете ви дозволити лише необхідні файли cookie, чи дозволити всі файли cookie.",
        settingsMessage: "<h3 style=\"    font-size: 25px;\">Ви маєте контроль</h3>"
            + "<p>Ми та наші надійні партнери використовуємо технології, такі як файли cookie, для збору інформації з різною метою, зокрема:</p>"
            + "<ol>"
            + "<li>Функціональні</li>"
            + "<li>Аналітика</li>"
            + "<li>Маркетинг</li>"
            + "</ol>"
            + "<p>Натискаючи «Прийняти», ви погоджуєтеся з усіма цими цілями. Крім того, ви можете вибрати конкретні цілі, з якими погоджуєтесь, позначивши прапорці та натиснувши «Зберегти налаштування».</p>"
            + "<p>Ви можете відкликати свою згоду в будь-який час, натиснувши на маленьку іконку в нижньому " + arrangeWord + " куті сайту.</p>",
        settingsMessageSuffix: '<button onClick="showPrivacy()" class="intastellarCookie-settings__privacyLink">Політика конфіденційності Intastellar Solutions, International</button>',
