(function () {
    ...
    window.__intaCmpLocalePayload = {
        ...
        bannerMessage: "Trí gach fianán a ghlacadh, tacaíonn tú le " + document.domain + " i bhforbairt réiteach níos fearr duitse.</p><p>Roghnaigh ar mhaith leat na fianáin riachtanacha amháin a cheadú nó gach fianán a cheadú.",
        settingsMessage: "<h3 style=\"    font-size: 25px;\">Tá an smacht agatsa</h3>"
            + "<p>Úsáidimid féin agus ár gcomhpháirtithe iontaofa teicneolaíochtaí, mar fhianáin, chun faisnéis a bhailiú chun críocha éagsúla, ina measc:</p>"
            + "<ol>"
            + "<li>Feidhmiúil</li>"
            + "<li>Anailísíocht</li>"
            + "<li>Margaíocht</li>"
            + "</ol>"
            + "<p>Trí chliceáil ar 'Glac Leis', tugann tú toiliú do na críocha seo go léir. Nó, is féidir leat na críocha sonracha lena n-aontaíonn tú a roghnú trí na boscaí seiceála a mharcáil agus cliceáil ar 'Sábháil Socruithe'.</p>"
            + "<p>Is féidir leat do thoiliú a tharraingt siar am ar bith trí chliceáil ar an deilbhín beag sa chúinne " + arrangeWord + " íochtair den suíomh gréasáin.</p>",
        settingsMessageSuffix: '<button onClick="showPrivacy()" class="intastellarCookie-settings__privacyLink">Beartas príobháideachais Intastellar Solutions, International</button>',
