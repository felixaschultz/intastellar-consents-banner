(function () {
    ...
    window.__intaCmpLocalePayload = {
        ...
        bannerMessage: "Kõigi küpsiste aktsepteerimisega toetate " + document.domain + " parema lahenduse arendamist teile.</p><p>Valige, kas lubada ainult vajalikke küpsiseid või kõiki küpsiseid.",
        settingsMessage: "<h3 style=\"    font-size: 25px;\">Sa oled kontrolli all</h3>"
