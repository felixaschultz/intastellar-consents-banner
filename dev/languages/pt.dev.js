(function () {
    ...
    var arrangeWord = (window.INTA && window.INTA.settings && window.INTA.settings.arrange == "ltr") ? "esquerda" : "direita";
    window.__intaCmpLocalePayload = {
        ...
        bannerMessage: "Ao aceitar todos os cookies, você apoia " + document.domain + " no desenvolvimento de uma solução melhor para você.</p><p>Escolha se deseja permitir apenas os cookies necessários ou se deseja permitir todos os cookies.",
        settingsMessage: "<h3 style=\"    font-size: 25px;\">Você está no controle</h3>"
            ...
            + "<p>Você pode retirar seu consentimento a qualquer momento clicando no pequeno ícone na parte inferior " + arrangeWord + " do site.</p>",
