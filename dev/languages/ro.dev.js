(function () {
    ...
    window.__intaCmpLocalePayload = {
        ...
        bannerMessage: "Acceptând toate cookie-urile, susțineți " + document.domain + " în dezvoltarea unei soluții mai bune pentru dvs.</p><p>Alegeți dacă doriți să permiteți doar cookie-urile necesare sau să permiteți toate cookie-urile.",
        settingsMessage: "<h3 style=\"    font-size: 25px;\">Dețineți controlul</h3>"
            + "<p>Noi și partenerii noștri de încredere folosim tehnologii, precum cookie-urile, pentru a colecta informații în diverse scopuri, printre care:</p>"
            + "<ol>"
            + "<li>Funcționale</li>"
            + "<li>Analitice</li>"
            + "<li>Marketing</li>"
            + "</ol>"
            + "<p>Făcând clic pe „Acceptă”, vă dați consimțământul pentru toate aceste scopuri. Alternativ, puteți selecta scopurile specifice cu care sunteți de acord, bifând casetele și făcând clic pe „Salvează setările”.</p>"
            + "<p>Vă puteți retrage consimțământul în orice moment făcând clic pe pictograma mică din colțul din " + arrangeWord + " jos al site-ului.</p>",
        settingsMessageSuffix: '<button onClick="showPrivacy()" class="intastellarCookie-settings__privacyLink">Politica de confidențialitate Intastellar Solutions, International</button>',
