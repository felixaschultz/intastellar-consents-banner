(function () {
    ...
    var arrangeWord = (window.INTA && window.INTA.settings && window.INTA.settings.arrange == "ltr") ? "sinistra" : "destra";
    window.__intaCmpLocalePayload = {
        ...
        bannerMessage: "Accettando tutti i cookie, supporti " + document.domain + " nello sviluppo di una soluzione migliore per te.</p><p>Scegli se vuoi consentire solo i cookie necessari o se vuoi consentire tutti i cookie.",
        settingsMessage: "<h3 style=\"    font-size: 25px;\">Sei al comando</h3>"
