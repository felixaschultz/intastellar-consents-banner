...
| Amazon Ads | Amazon Ads' advertising and measurement products (e.g. Amazon DSP, Amazon Marketing Cloud) used to track conversions and attribution for ads served via Amazon surfaces. | [Amazon Consent Signal (ACS)](https://advertising.amazon.com/resources/ad-policy/consent-signal-requirements) — first-party `amzn_consent` cookie |
